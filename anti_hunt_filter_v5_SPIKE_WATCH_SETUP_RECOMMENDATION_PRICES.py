...
def send_telegram_alert(text):
    ...
    try:
        ...
        print(f"TELEGRAM ERROR: HTTP request failed: {exc}")
        print("Alert text follows:")
        print(text)
        return False
...
def format_message(setup, report):
    ...
    if setup.get("manual_mode"):
        lines.append("🧪 <b>MANUAL TEST ALERT</b> — stale-data protection bypassed for this manual run.")
