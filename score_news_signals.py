...
news_scanner.py). Checks every logged news_signal_log.json entry old
enough to have a real outcome, and marks it WIN/LOSS the same way
...
def score_one_signal(entry, price_df):
    ...
    if not actual_up and not actual_down:
        outcome = 'FLAT'  # price didn't move enough either way to judge
